...
function CollectionManager({ title, table, fields, fallbackRows, readOnly = false, filters = {}, editableKeys }: { title: string; table: string; fields: readonly ManagerField[]; fallbackRows: Row[]; readOnly?: boolean; filters?: Record<string,string>; editableKeys?: readonly string[] }) {
...
<p className="mt-2 text-zinc-300">Edite os títulos e descrições usados pelos motores de pesquisa e pela partilha do site.</p>
<CollectionManager title="Páginas e SEO" table="pages" fields={[{key:'slug',label:'Slug'},{key:'title',label:'Título'},{key:'seo_title',label:'Título SEO'},{key:'seo_description',label:'Descrição SEO',type:'textarea'},{key:'share_image_url',label:'Imagem de partilha',type:'url'},{key:'is_published',label:'Publicado',type:'boolean'}]} fallbackRows={[{slug:'home',title:'Associação Cultural Girassol',seo_title:'Associação Cultural Girassol',seo_description:'Teatro, cultura e juventude em Moçambique.',share_image_url:'',is_published:true},{slug:'fiti',title:'FITI',seo_title:'FITI – Festival Internacional Teatro de Inverno',seo_description:'Festival internacional da Associação Cultural Girassol.',share_image_url:'',is_published:true}]} />
</section>
